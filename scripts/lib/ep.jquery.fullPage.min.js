      ...
      $(document).keydown(function(e) {
         ...
         if (options.keyboardScrolling && !isMoving) {
            switch (e.which) {
               ...
               //left
               case 37:
                  // console.log('keydown', slideMoving);
                  if (slideMoving) {
                     e.preventDefault();
                     e.stopPropagation();
                     return false;
      ...
      */
      ...
      function createSlimScrolling(element){
         ...
         if(scrollable.length){
            ...
            if(options.verticalCentered && element.find('.tableCell').get(0)) {
               contentHeight = element.find('.tableCell').get(0).scrollHeight;
            }
         }

         var scrollHeight = Math.abs(windowsHeight - parseInt(section.css('padding-bottom')) - parseInt(section.css('padding-top')));
         ...
         if ( contentHeight > scrollHeight) {
            ...
            //creating the scrolling
               ...
               if (element.attr('id') === 'sec-cursos') {
                  // element.find('.scrollable').css('overflow', 'hidden');
               }
               else {

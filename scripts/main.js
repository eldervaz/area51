  ...
  function setGoogleMaps() {
    if (GMaps) {
      ...
      /*markers.miraflores = map.addMarker({ // GMarker de Miraflores
        ...
        title: 'Miraflores',
        infoWindow: {
          content: '<div class="scrollFix">' + 'Sede Miraflores<br>255-9429' + '</div>'
        }
      });*/
      markers.villa = map.addMarker({ // GMarker de Villa
        ...
        title: 'Villa',
        infoWindow: {
          content: '<div class="scrollFix">' + 'Sede San Isidro<br>363-7605' + '</div>'
        }
      });
      //map.fitZoom();
    }
    ...
    if (!supportBlacklist() && !isMobile()) {
      ...
      $.fn.fullpage({
        ...
        'afterSlideLoad': function (anchorLink, index, slideAnchor, slideIndex) {
          ...
          if ($('.section.active').attr('id') === 'sec-inicio') {
